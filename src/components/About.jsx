      ...
      <div className="w-full max-w-[1200px] mx-auto px-8 lg:px-12" ref={ref}>
        ...
        <div className="grid md:grid-cols-2 gap-10 lg:gap-14">
          ...
          >
            ...
            <p className="text-sm text-text-muted leading-relaxed">
              B.Tech in Computer Science from Parul University (2026), based in Gurugram, Haryana. Open to remote roles at startups where AI is central to what they build.
            </p>
